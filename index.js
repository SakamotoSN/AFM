    ...
    if (message.content.includes("@everyone")){
     ...
     return;
      ...
      console.log("pas de everyone")
        ...
        console.log("passage !")
    if ( (texte.toLowerCase()) === ("quoi", (texte.lenght-5) ) ||  (texte.toLowerCase()).includes("quoi.", (texte.lenght-6) ) ||  (texte.toLowerCase()).includes("quoi?", (texte.lenght-6) )||  (texte.toLowerCase()).includes("quoi!", (texte.lenght-6) )){
