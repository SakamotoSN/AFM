    ...
    if (message.content.includes("@everyone")){
     ...
     return;
      ...
      console.log("pas de everyone")
        ...
        console.log("passage !")
        console.log( (texte.lenght)-5)
    if ( (texte.toLowerCase().includes) === ("quoi", (texte.lenght-5) ) ||  (texte.toLowerCase()).includes("quoi.", (texte.lenght-6) ) ||  (texte.toLowerCase()).includes("quoi?", (texte.lenght-6) )||  (texte.toLowerCase()).includes("quoi!", (texte.lenght-6) )){
