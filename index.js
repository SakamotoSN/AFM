...
if (message.author.bot) return; //le bot ne peu pas prendre ces message
  ...
  if ( (texte.toLowerCase()).includes("quoi",4)){ //=== ('quoi') || (texte.toLowerCase()) === ('quoi?') || (texte.toLowerCase()) === ('quoi!') || (texte.toLowerCase()) === ('quoi.') || ('pourquoi') || (texte.toLowerCase()) === ('pourquoi?') || (texte.toLowerCase()) === ('pourquoi!') || (texte.toLowerCase()) === ('pourquoi.') ){
